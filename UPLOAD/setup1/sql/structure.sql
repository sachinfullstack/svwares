...
('BitSet Limited', 'http://localhost/eb', 'support@bitset.org', '123 Main St.', 'Toronto', 'Ontario', 'M2J 1K5', '555-555-5555', '444-444-4444', 'logo.png', '%b %d %Y', '%d %B %Y %H:%M', 'America/Toronto', 'en', 1, 'master', 1, 1, 'HST', '0.13', '123456789-WOJO-321', 1, 'Instructions for offline payments\r\nSuch as bank info, address etc...', 'You can enter here your company policy or any other info', 'RTB-ST5', 'QUO-1010', 1, 'gif,png,jpg,jpeg,pdf,zip,rar', '10485760', '10', '03-Jan-2015_00-57-16.sql', 'CAD', '$', ',', '.', '', '', '', 0, 10, 'PHP', '', '', '', 25, '/usr/sbin/sendmail -t -i', 0, '2.0.0', 60, 'dfsvjfdsj', 'defcsd', 'dsfsd', 'dsf', 'dsfs', 'sdf', 'dsfsd');
