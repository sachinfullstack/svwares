				...
				<section class="col col-12">
					...
					<?php foreach ($arow as $answers):?>
						...
						<?php } else if($qrow->type == 2){?>
							<label class="radio">
							<input type='radio' name='marked' value='<?php echo $l; ?>' /><i></i><?php echo $k; ?>) <?php echo htmlspecialchars_decode($answers->answer); ?></label>
						...
						<?php } else if($qrow->type == 3){?>
							<label class="radio">
							<input type='checkbox' name='marked[<?php echo $l; ?>]' value='1' /><i></i><?php echo $k; ?>) <?php echo htmlspecialchars_decode($answers->answer); ?></label>
							<input type="hidden" name="correct[]" value="<?php echo $answers->correct;?>" />
							<input type="hidden" name="answer[]" value="<?php echo $answers->answer;?>" />
